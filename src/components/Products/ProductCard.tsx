        ...
        <>
            <div className=" w-full lg:w-80 overflow-hidden bg-white shadow-lg dark:bg-gray-800 font-inter hover:scale-105 transition duration-300 cursor:pointer group">
                ...
                <div className="py-3 flex ml-0 pl-0 space-x-4 justify-around items-center cursor-pointer">
                    <h1 className="text-lg font-semibold ml-1 text-primary-black uppercase 
                    dark:text-white border-2 border-secondary-gray w-2/3 text-center h-8">
                        {props.name}</h1>
                ...
                <div className="relative cursor-pointer" onClick={() => router.push('/shop/' + props.id)}>
                ...
                <div className="flex items-center justify-between space-x-3 py-2 bg-white mt-4 cursor-pointer">
                    <h1 className="px-2 py-1 text-primary-black font-inter font-semibold italics w-2/4 text-center border-2 border-secondary-gray h-14 pt-3">{props.description}</h1>
