...
const ProductCard: React.FC<props> = (props) => {
    return (
        <>
            <div className="w-80 overflow-hidden bg-white shadow-lg dark:bg-gray-800 font-inter">
                <div className="h-0.5 max-h-0.5 bg-gradient-to-r to-lime-700 from-lime-900 w-full"> </div>
                <div className="py-3 flex ml-0 pl-0 space-x-4 justify-around items-center">
                ...
                <div className="flex items-center justify-between space-x-3 py-2 bg-white mt-4">
